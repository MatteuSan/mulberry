<div
  ...
  style="border-width:1px;border-style:solid;{{ $isUnread ? 'border-color:var(--ms-theme-accent-400) !important;' : '' }}"
>
  <div>
    <a wire:navigate href="{{ route('academics.announcements.id', ['id' => $id]) }}" role="link">
      <div class="flex flow-row wrap-none ai-center gap-sm">
        <i style="width: 30px; height: 30px; color: var(--ms-theme-warning-400);">
